...
describe('Service Tests', () => {
  describe('RfbLocation Service', () => {
    ...
    describe('Service methods', () => {
      ...
      it('should create a RfbLocation', async () => {
      ...
      it('should update a RfbLocation', async () => {
        const returnedFromService = Object.assign(
          {
            locationName: 'BBBBBB',
            runDayOfWeek: 1
      ...
      it('should return a list of RfbLocation', async () => {
        const returnedFromService = Object.assign(
          {
            locationName: 'BBBBBB',
            runDayOfWeek: 1
      ...
      it('should delete a RfbLocation', async () => {

...
describe('Service Tests', () => {
  describe('RfbUser Service', () => {
    ...
    describe('Service methods', () => {
      ...
      it('should create a RfbUser', async () => {
      ...
      it('should update a RfbUser', async () => {
        const returnedFromService = Object.assign(
          {
            username: 'BBBBBB'
          },
      ...
      it('should return a list of RfbUser', async () => {
        const returnedFromService = Object.assign(
          {
            username: 'BBBBBB'
          },
      ...
      it('should delete a RfbUser', async () => {
